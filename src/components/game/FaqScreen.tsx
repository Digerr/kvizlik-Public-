...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'Поделись ссылкой на КВИЗЛИК с другом — когда он зайдёт по твоей ссылке, вы оба получите по 50 монет! Ссылку можно найти на главном экране. Чем больше друзей приглашаешь — тем больше монет.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Нашли баг или есть предложение? Пишите @Digerr в Telegram. Мы всегда рады обратной связи!',
  },
];
